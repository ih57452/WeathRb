...
It either needs to have a data file (sn.last) in the same folder as the script, or you can uncomment the @site_id@ variable in the script to have it load the latest data file from the internet.
